...
namespace InventorySystem.Controls
{
    public class CustomDateTimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = TodoApp.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = TodoApp.Properties.Resources.calendarDark;
                else calendarIcon = TodoApp.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
